...
static class Patterns {
    public const string Result = """
        ...
        {OkInterfaceProperty}
            ...
            public {OkDeclarationModifiers}{OkType} {OkProperty} =>
                state switch {
                    ...
                    {ResultState}.Error         => throw global::Perf.Holders.ResultHolderExceptions.ErrorAccessWhenOk<{ResultShort}, {OkType}, {ErrorType}>("{OkProperty}", "{ErrorProperty}"),
                    {ResultState}.Uninitialized => throw global::Perf.Holders.ResultHolderExceptions.Uninitialized<{ResultShort}, {OkType}, {ErrorType}>(),
                    _ => throw global::Perf.Holders.ResultHolderExceptions.StateOutOfValidValues<{ResultShort}, {OkType}, {ErrorType}>(state)
                };
        {ErrorInterfaceProperty}
            {DebuggerBrowsableNever}
            public {ErrorDeclarationModifiers}{ErrorType} {ErrorProperty} =>
                state switch {
                    {ResultState}.Ok            => throw global::Perf.Holders.ResultHolderExceptions.OkAccessWhenError<{ResultShort}, {OkType}, {ErrorType}>("{OkProperty}", "{ErrorProperty}"),
        ...
        // Casting
            ...
            public TOther CastByRef<TOther>() where TOther : struct, global::Perf.Holders.IResultHolder<{OkType}, {ErrorType}> {
                var t = this;
                return global::Perf.Holders.___HoldersInvisibleHelpers.CastResult<{ResultShort}, {OkType}, {ErrorType}, TOther>(ref t);
            }
            ...
            public bool Equals({ResultShort} other) =>
                (state, other.state) switch {
                    ...
                    ({ResultState}.Uninitialized, {ResultState}.Uninitialized)
                        => throw global::Perf.Holders.ResultHolderExceptions.Uninitialized<{ResultShort}, {OkType}, {ErrorType}>(),
                    _   => throw global::Perf.Holders.ResultHolderExceptions.StateOutOfValidValues<{ResultShort}, {OkType}, {ErrorType}>(state)
                };
    ...
    public const string Option = """
        ...
        // Casting
            ...
            public TOther CastByRef<TOther>() where TOther : struct, global::Perf.Holders.IOptionHolder<{SomeType}> {
                var t = this;
                return global::Perf.Holders.___HoldersInvisibleHelpers.CastOption<{OptionShort}, {SomeType}, TOther>(ref t);
            }
        // Equality
            public override bool Equals(object? obj) =>
